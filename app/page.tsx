...
const Portfolio = dynamic(() => import('@/components/sections/Portfolio/Portfolio').then(m => m.Portfolio), {
  loading: () => (
...
const CTAFinal = dynamic(() => import('@/components/sections/CTAFinal/CTAFinal').then(m => m.CTAFinal), {
  loading: () => (
